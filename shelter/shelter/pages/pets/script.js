...
/* harmony import */ var _main_js_mock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../main/js/mock */ "./src/main/js/mock.js");
...
class Pagination {
  ...
  _getTemplateContent() {
    ...
    // отдаем количество карточек в зависимости от разрешения экрана,
    ...
    this._pets = Object(_main_js_mock__WEBPACK_IMPORTED_MODULE_0__["getRandomPets"])(countPet);
